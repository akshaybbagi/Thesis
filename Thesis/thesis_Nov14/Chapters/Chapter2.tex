...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{RDDP_first_image}
...
\includegraphics[width=1\textwidth]{RDDP_pitch_down}
...
\end{minipage}
\begin{minipage}{1\textwidth}
\includegraphics[width=0.5\textwidth]{Ballast_plates}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.1\textwidth]{RDDP_Geometry}
\caption{\label{fig:RDDP_Geometry}Simplified model of the RDDP for numerical study.}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=1.1\textwidth]{Log_Geometry}
